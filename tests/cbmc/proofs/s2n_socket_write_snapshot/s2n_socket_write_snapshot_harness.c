...
/**
 * @file s2n_socket_write_snapshot_harness.c
 * @brief Implements the proof harness for s2n_socket_write_snapshot function.
 */
...
void s2n_socket_write_snapshot_harness()
{
  ...
  int result = s2n_socket_write_snapshot(s2n_connection);
