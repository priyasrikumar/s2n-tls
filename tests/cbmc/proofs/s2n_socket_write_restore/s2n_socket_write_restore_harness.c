...
/**
 * @file s2n_socket_write_restore_harness.c
 * @brief Implements the proof harness for s2n_socket_write_restore function.
 */
...
void s2n_socket_write_restore_harness()
{
  ...
  int result = s2n_socket_write_restore(s2n_connection);
